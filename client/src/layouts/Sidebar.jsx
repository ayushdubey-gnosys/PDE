...
const Sidebar = () => {
  const navItems = [
    ...
    { name: 'Import', path: '/import', icon: <UploadCloud className="w-5 h-5 mr-3" /> },
    { name: 'Export', path: '/export', icon: <DownloadCloud className="w-5 h-5 mr-3" /> },
    { name: 'Tags', path: '/tags', icon: <Tags className="w-5 h-5 mr-3" /> },
